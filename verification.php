        ...
        if ($verification) {
            ...
            switch($_SESSION['LOGGED_USER']['user_type']) {
                case 'admin':
                    ...
                    break;
                case 'professor':
                    redirectToUrl('professor.php');
                    break;
                case 'student':
                    redirectToUrl('student.php');
                    break;
                default:
                ...
                <div class="w-full bg-white/90 backdrop-blur-sm rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800/90 dark:border-gray-700">
                    <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <p class="text-sm text-gray-600 dark:text-gray-400 text-center">
                            Un code de vérification a été envoyé à votre adresse email (<?php echo $_SESSION['PENDING_USER']['email']; ?>).<br>
